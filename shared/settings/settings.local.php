...
#$config['system.file']['path']['file'] = '/srv/www/private';
#$settings['file_private_path'] = '/srv/www/private';
...
/**
 * Docksal compatibility settings.
 */
...
// Drupal hash salt.
// Copy the hash_salt generated by the site when installing it.
$settings['hash_salt'] = 'CHANGE_ME';

// HID credentials.
/*
$config['social_auth_hid.settings']['client_id'] = 'HID_CLIENT_ID';
$config['social_auth_hid.settings']['client_secret'] = 'HID_CLIENT_SECRET';
 */

// Stage file proxy settings.
$config['stage_file_proxy.settings']['origin'] = 'https://ocha:dev@dev.numbers-rwlabs-org.ahconu.org/';
